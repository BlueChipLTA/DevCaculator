...
public class CalculatorActivity extends Activity
    ...
    private void onModeChanged(boolean degreeMode) {
        if (mPadViewPager != null) {
            LinearLayout linearLayout = (LinearLayout) mPadViewPager.getChildAt(1);
            TextView textViewMode = linearLayout.findViewById(R.id.toggle_mode);
            if (degreeMode) {
                textViewMode.setText(R.string.mode_rad);
            } else {
                textViewMode.setText(R.string.mode_deg);
            }
        }
        if (degreeMode) {
