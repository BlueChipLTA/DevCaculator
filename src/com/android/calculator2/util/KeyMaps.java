...
public class KeyMaps {
    ...
    public static String toString(Context context, int id) {
        switch (id) {
            ...
            case R.id.fun_10pow:
                return context.getString(R.string.digit_1) + context.getString(R.string.digit_0) + context.getString(R.string.op_pow);
            case R.id.lparen:
            ...
            case R.id.op_sqr:
                // Button label doesn't work.
                return context.getString(R.string.op_pow)+context.getString(R.string.lparen) +context.getString(R.string.digit_2) + context.getString(R.string.rparen);
            case R.id.dec_point:
                return ".";
            case R.id.digit_0:
